...
(function (Skin) {
    ...
    function getFontDescShift() {
        var v = getProperties().fontDescShift;
        return typeof v === 'number' ? v : 0.3;
    }
    Skin.getFontDescShift = getFontDescShift;
    // Stroke width (in SVG units) of the wires drawn between components,
    // read from <s:properties wireStrokeWidth="..."/>. 
    function getWireStrokeWidth() {
        var v = getProperties().wireStrokeWidth;
        return typeof v === 'number' ? v : 1;
    }
    Skin.getWireStrokeWidth = getWireStrokeWidth;
